...
//
//  Created by AppstoneLab on 09/09/14.
//  Copyright (c) 2014 AppstoneLabnology. All rights reserved.
//
...
+ (HelperMethod *) HelperMethodObject
{
    return [HelperMethod new];
}
...
-(void)SetviewBorder:(UIScrollView *)view width:(int)width
{
    ...
    bottomBorder.backgroundColor = [obNet colorWithHexString:@"#E3E3E3" alpha:1.0].CGColor;
